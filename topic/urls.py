...
urlpatterns = [
    ...
    path('<str:slug1>/skill/<str:slug2>/grade_edit/', skill_grade_edit),  
    path('<str:slug1>/skill/<str:slug2>/grade_edit/<int:level>/', skill_grade_edit_next),  
    path('<str:slug1>/skill/<str:slug2>/grade_delete/', skill_grade_delete),  
    path('<str:slug1>/skill/<str:slug2>/grade_delete/<int:level>/', skill_grade_delete_next), 
